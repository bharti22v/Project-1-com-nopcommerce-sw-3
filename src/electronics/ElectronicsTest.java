...
public class ElectronicsTest extends Utility {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        sendTextToElement(By.id("FirstName"), "Bharti");                                                       //Enter first name
        sendTextToElement(By.id("LastName"), "Kumawat");                                                     //Enter last name
        sendTextToElement(By.id("Email"), emailID);
        selectByValueFromDropDown(By.name("DateOfBirthDay"), "22");
        selectByValueFromDropDown(By.name("DateOfBirthMonth"), "8");
        selectByValueFromDropDown(By.name("DateOfBirthYear"), "1984");
        sendTextToElement(By.id("Password"), "MummyPapa");                                                   //Enter password
        sendTextToElement(By.id("ConfirmPassword"), "MummyPapa");                                            //Confirm password
        ...
        sendTextToElement(By.id("BillingNewAddress_PhoneNumber"), "0743567345");
        // Click on “CONTINUE”
        ...
        sendTextToElement(By.id("CardNumber"), "4374101301649865");
