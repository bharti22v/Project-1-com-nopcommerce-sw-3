...
//            2.20 Verify the Text “Welcome, Please Sign In!”
        ...
        sendTextToElement(By.id("BillingNewAddress_FirstName"),"Bharti");   //insert username
        sendTextToElement(By.id("BillingNewAddress_LastName"),"Kumawat");         //insert lastname
        sendTextToElement(By.id("BillingNewAddress_Email"),"sunil123@gmail.com");    //insert random email id
        selectByValueFromDropDown(By.id("BillingNewAddress_CountryId"),"233");   //select your country
        Thread.sleep(1000);
        sendTextToElement(By.id("BillingNewAddress_City"),"Reading");   //insert city name
        sendTextToElement(By.id("BillingNewAddress_Address1"),"407 Eden Road");   //insert address
        sendTextToElement(By.id("BillingNewAddress_ZipPostalCode"),"RJ3 4SE");           //insert postcode
        sendTextToElement(By.id("BillingNewAddress_PhoneNumber"),"07000000001");     //enter user phone number
        Thread.sleep(2000);
        ...
        sendTextToElement(By.id("CardholderName"),"Bharti");
        sendTextToElement(By.id("CardNumber"),"896410176319885");
        selectByValueFromDropDown(By.id("ExpireMonth"),"10");
        Thread.sleep(1000);
        selectByValueFromDropDown(By.id("ExpireYear"),"2025");
        sendTextToElement(By.id("CardCode"),"174");
